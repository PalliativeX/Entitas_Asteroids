...
namespace Utils
{
    ...
    {
        public static void ForEach<T>(this T[] array, System.Action<T> callback) where T : class
        {
        ...
        public static T GetRandomExcept<T>(this T[] arr, T ignored) where T : class
        {
            T random;
            do
        ...
        public static T GetRandomExcept<T>(this List<T> list, T ignored) where T : class
        {
            T random;
            do
            ...
            T ignored = null) where T : MonoBehaviour
        {
            ...
            foreach (T sittable in monoBehaviours)
            {
