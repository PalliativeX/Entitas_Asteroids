...
public partial class MetaContext {
    ...
    public MetaEntity SetTimeService(Sources.Services.Time.ITimeService newInstance) {
        if (hasTimeService) {
    ...
    public void ReplaceTimeService(Sources.Services.Time.ITimeService newInstance) {
...
public partial class MetaEntity {
    ...
    public void AddTimeService(Sources.Services.Time.ITimeService newInstance) {
